...
//	define ('K_PATH_IMAGES', '../../../public/img/');
	 ...
	 * document author
	 */
	define ('PDF_AUTHOR', 'CEP - ULA');
	
	/**
	 * header title
	 */
//	define ('PDF_HEADER_TITLE', 'SINACIF');
	define ('PDF_HEADER_TITLE', '');
	
	/**
	 * header description string
	 */
//	define ('PDF_HEADER_STRING', "CEP");
	define ('PDF_HEADER_STRING', "");
	
	/**
	 * image logo
	 */
//	define ('PDF_HEADER_LOGO', 'home/bannerImp1.gif');
//	define ('PDF_HEADER_LOGO', 'home/bannerImpPredet.gif');
//	define ('PDF_HEADER_LOGO', 'home/bannerImpPredet.gif');
