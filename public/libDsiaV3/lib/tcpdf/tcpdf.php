	...
	*/
	class TCPDF {
		...
		*/
		...
		/**
		 * @var Text on the footer.
		 * @access private
		 */
		private $footer_text;

		/**
		 * @var Text under the footer.
		 * @access private
		 */
		private $subfooter_text;
		...
		*/
		...
		/**
	 	 * Set footer data.
		 * @param string $ft string to print as title on document footer
		 * @param string $sft string to print as title on document under the footer
		*/
		public function setFooterData($ft="", $sft="") {
			$this->footer_text = $ft;
			$this->subfooter_text = $sft;
		}
...
//				$this->Ln(1);
				$this->Ln(4);
				$this->MultiCell(0,3,$this->footer_text,0,'R',0);
				$this->Ln(1);
				$this->MultiCell(0,2,$this->subfooter_text,0,'R',0);			
		}
