(function ($) {
  ...
  $.extend($.fn.wPaint.cursors, {
    ...
    eraser2:   {path: 'sihco/public/plugins/main/img/cursor-eraser2.png', left: 2, top: 2},
    eraser3:   {path: 'sihco/public/plugins/main/img/cursor-eraser3.png', left: 2, top: 2},
    eraser4:   {path: 'sihco/public/plugins/main/img/cursor-eraser4.png', left: 3, top: 3},
    eraser5:   {path: 'sihco/public/plugins/main/img/cursor-eraser5.png', left: 3, top: 3},
    eraser6:   {path: 'sihco/public/plugins/main/img/cursor-eraser6.png', left: 4, top: 4},
    eraser7:   {path: 'sihco/public/plugins/main/img/cursor-eraser7.png', left: 4, top: 4},
    eraser8:   {path: 'sihco/public/plugins/main/img/cursor-eraser8.png', left: 5, top: 5 },
    eraser9:   {path: 'sihco/public/plugins/main/img/cursor-eraser9.png', left: 5, top: 5},
    eraser10:  {path: 'sihco/public/plugins/main/img/cursor-eraser10.png', left: 6, top: 6}
  });

  // extend defaults
  $.extend($.fn.wPaint.defaults, {
    mode:        'ellipse',  // set mode
