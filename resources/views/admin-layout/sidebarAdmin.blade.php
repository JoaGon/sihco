       ...
       @if( Auth::user()->rol_id == 1)
        ...
        @endif
         ...
         @if( Auth::user()->rol_id == 2)
          <nav class="navbar navbar-default navbar-static-top" id="barra" role="navigation" style="margin-bottom: 0; background: #68aaaa">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
        ...
        @endif
         @if( Auth::user()->rol_id == 3)
          <nav class="navbar navbar-default navbar-static-top" id="barra" role="navigation" style="margin-bottom: 0; background: #68aeee">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
        ...
        @endif
         @if( Auth::user()->rol_id == 4)
          <nav class="navbar navbar-default navbar-static-top" id="barra" role="navigation" style="margin-bottom: 0; background: #68abbb">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
        ...
        @endif
         @if( Auth::user()->rol_id == 5)
          <nav class="navbar navbar-default navbar-static-top" id="barra" role="navigation" style="margin-bottom: 0; background: #68accc">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
        ...
        @endif
         @if( Auth::user()->rol_id == 6)
          <nav class="navbar navbar-default navbar-static-top" id="barra" role="navigation" style="margin-bottom: 0; background: #7468ac">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                    <span class="sr-only">Toggle navigation</span>
                    <span class="icon-bar"></span>
        ...
        <div class="navbar-default sidebar" style=" margin-top: -0.5px;" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <!--/li-->
                    <li>
                        <a href="{{ url('/consulta') }}"><i class="fa fa-files-o fa-fw"></i> Anexar a la Historia</a>
                    </li>
                    <li>
