...
<script type="text/javascript" src="{{ url('js/UpdateDashboard.js') }}"></script>
<!-- DataTables CSS -->
...
<div class="container"  ng-app="UpdateDashboard" ng-controller="UpdateController">
    <!-- /.row -->
    <div class="row">
            ...
            <div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" background-color:white;padding-left:0; margin-top: 25px">
                ...
                <form class="form-horizontal" id="form_familiares">
                    ...
                    <div class="row row_border ">
                        ...
                        <div class="col-lg-12">
                            <textarea name="espec_otro" id="espec_otro" placeholder="Otros" class="form-control" data-validation="required" data-validation-depends-on="otro" data-validation-error-msg="Debe especificar otra enfermedad" style="height: 100px;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
...
<script>
    $(document).ready(function() {
        ...
        $.each(antecendetes,function(i,val){
            ...
            $('#id_enfermedad').val(val.id_antecedente_familiar);
            $('#fecha').val(val.fecha);
        });
...
function insertar_familiares(){
    ...
    onSuccess : function($form) {
      ...
      var formData = new FormData($("#form_familiares")[0]);
          $.ajax({
            url: "{{ url('/update_antecedente_familiar') }}",
            type: 'POST',
            data: formData,
            async: false,
            cache: false,
            ...
            success: function(){
                ...
                new PNotify({
                      ...
                      text: 'Los Antecedentes Familiares han sido actualizados!',
                      type: 'success',
                      styling: 'bootstrap3'
                  });
                console.log('exito')
