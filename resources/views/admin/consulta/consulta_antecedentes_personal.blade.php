...
<script type="text/javascript" src="{{ url('js/UpdatePersonal.js') }}"></script>
<!-- DataTables CSS -->
...
<script>
var enfer_cardiovascular = <?php echo json_encode($enfermedades_cardiovasculares); ?>;

  console.log("card",enfer_cardiovascular);
var enfer_renal = <?php echo json_encode($enfermedades_renales); ?>;
var enfermedades_alergicas = <?php echo json_encode($enfermedades_alergicas); ?>;
var enfermedades_infecciosas = <?php echo json_encode($enfermedades_infecciosas); ?>;
var enfermedades_sexuales = <?php echo json_encode($enfermedades_sexuales); ?>;
var enfermedades_cancer = <?php echo json_encode($enfermedades_cancer); ?>;
var valido = <?php echo json_encode($validado); ?>;
var antecendetes = <?php echo json_encode($ante); ?>;
console.log(antecendetes, enfer_cardiovascular);
</script>
<div class="container"  >
    <!-- /.row -->
    <div class="row" ng-app="UpdatePersonal" ng-controller="UpdatePersonalController">
                ...
                <form class="form-horizontal" id="form_familiares">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" id="fecha_consulta" type="text" class="form-control" data-validation="required" data-validation-error-msg="Debe ingrear una fecha" class="form-control" name="fecha" value="{{ old('fecha_consulta') }}">
                        </div>
                    </div>
                    ...
                    <div class="row row_border ">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                            <input type="checkbox" name="" id="enfer_infecciosa" onchange="insertar_infecciosa()" value="S"> 9-Enfermedades Infecciosas
                        </div>
                    ...
                    <div class="row row_border ">
                        ...
                        <div class="col-lg-12">
                            <textarea name="espec_interv_quirurgica" id="espec_interv_quirurgica" placeholder="Especifique" class="form-control" data-validation="required" data-validation-depends-on="intervencion_quirurgica" data-validation-error-msg="Debe especificar la intervencion quirurgica" style="height: 100px;"></textarea>
                        </div>
                    </div>
                    <div class="row row_border ">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                        ...
                        <div class="col-lg-12">
                            <textarea name="espec_trauma_accidente" id="espec_trauma_accidente" placeholder="Especifique" class="form-control" data-validation="required" data-validation-depends-on="trauma_accidente" data-validation-error-msg="Debe especificar el trauma por accidente" style="height: 100px;"></textarea>
                        </div>
                    </div>
                    <div class="row row_border ">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                        ...
                        <div class="col-lg-12">
                            <textarea name="espec_fractura" id="espec_fractura" placeholder="Especifique" class="form-control" data-validation="required" data-validation-depends-on="fractura" data-validation-error-msg="Debe especificar la fractura" style="height: 100px;"></textarea>
                        </div>
                    </div>
                    <div class="row row_border ">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                    ...
                    <div class="row row_border ">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                            <input type="checkbox" name="otro" id="otro" value="S"> 23-Otro
                        </div>
                        <div class="col-lg-12">
                            <textarea name="espec_otro" id="espec_otro" placeholder="Especifique Otros" class="form-control" data-validation="required" data-validation-depends-on="otro" data-validation-error-msg="Debe especificar" style="height: 100px;"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6 col-md-offset-4">
                        @if( Auth::user()->rol_id == 1 or Auth::user()->rol_id == 2 or Auth::user()->rol_id == 3 )
                            <button id="validar-button" type="submit" onclick="validar();" class="btn btn-primary">Validar</button>
                        @endif
                            <button id="registrar-button" type="submit" onclick="insertar_familiares();" class="btn btn-primary">Registrar</button>
...
$(document).ready(function() {
    if (enfer_cardiovascular.length > 0) {
        $('#enfer_cardiov').prop('checked', true)
    }
    if (enfer_alergica.length > 0) {
        $('#enfer_alergica').prop('checked', true)
    }
    if (enfermedades_infecciosas.length > 0) {
        $('#enfer_infecciosa').prop('checked', true)
    }
    if (enfer_renal.length > 0) {
        $('#enfer_renal').prop('checked', true)
    }
    if (enfermedades_sexuales.length > 0) {
        $('#enfer_trasnm_sexual').prop('checked', true)
    }
    ...
    $.each(antecendetes, function(i, val) {
        $('#artritis_reumatoidea').prop('checked', check('S', val.artritis_reumatoidea));
        $('#discrasia_sanguinea').prop('checked', check('S', val.discrasia_sanguinea));
        $('#enfer_meta_endocrina').prop('checked', check('S', val.enfer_meta_endocrina));
        $('#fiebre_reumatica').prop('checked', check('S', val.fiebre_reumatica));
        $('#neuropsicopatia').prop('checked', check('S', val.neuropsicopatia));
        $('#intervencion_quirurgica').prop('checked', check('S', val.intervencion_quirurgica));
        $('#accidente_transito').prop('checked', check('S', val.accidente_transito));
        $('#otro').prop('checked', check('S', val.otro));
        $('#espec_otro').val(val.espec_otro);
        $('#id_enfermedad').val(val.id_antecedente_personal);
        $('#cefalea').prop('checked', check('S', val.cefalea));
        $('#edema_miembro_inf').prop('checked', check('S', val.edema_miembro_inf));
        $('#erupciones_piel').prop('checked', check('S', val.erupciones_piel));
        $('#fractura').prop('checked', check('S', val.fractura));
        $('#ictericia').prop('checked', check('S', val.ictericia));
        $('#intervencion_quirurgica').prop('checked', check('S', val.intervencion_quirurgica));
        $('#parestesias').prop('checked', check('S', val.parestesias));
        $('#trastorno_audicion').prop('checked', check('S', val.trastorno_audicion));
        $('#trauma_accidente').prop('checked', check('S', val.trauma_accidente));
        $('#espec_interv_quirurgica').val(val.espec_interv_quirurgica);
        $('#espec_meta_endocrina').val(val.espec_meta_endocrina);
        $('#espec_trauma_accidente').val(val.espec_trauma_accidente);
        $('#espec_accidente_transito').val(val.espec_trauma_accidente);
        $('#espec_interv_quirurgica').val(val.espec_interv_quirurgica);
        $('#espec_fractura').val(val.espec_fractura);
...
function insertar_familiares() {
     console.log("dasddasd",$("#form_familiares")[0]);
    var myLanguage = {
    ...
    $.validate({
        ...
        onSuccess: function($form) {
            ...
            $.ajax({
                url: "{{ url('/update_antecedente_personal') }}",
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
                ...
                success: function() {
                    ...
                    new PNotify({
                        ...
                        text: 'Los Antecedentes Personales han sido actualizados!',
                        type: 'success',
                        styling: 'bootstrap3'
                    });
                    console.log('exito')
...
function validar() {
    ...
    $.ajax({
        ...
        url: "{{ url('/validar_antecedente_personal') }}",
        type: "POST",
        data: {
