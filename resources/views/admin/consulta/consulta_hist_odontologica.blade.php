                ...
                <form class="form-horizontal" id="form_familiares">
                    ...
                    <div class="row row_border">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" data-validation="required" data-validation-depends-on="complic_pos_exo" data-validation-error-msg="Debe indicar el tipo de complicacion" id="tipo_complicacion" name="tipo_complicacion">
                    ...
                    <div class="row row_border ">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="tipo_tratamiento" name="tipo_tratamiento" data-validation="required" data-validation-depends-on="periodoncia" data-validation-error-msg="Debe indicar que tipo">
                                <option value="" selected>Selecione..</option>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="tipo_protesis" name="tipo_protesis" data-validation="required" data-validation-depends-on="protesis_dental" data-validation-error-msg="Debe indicar que tipo">
                                <option value="" selected>Selecione..</option>
                    ...
                    <div class="row row_border ">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="razon_mastica" name="razon_mastica" data-validation="required" data-validation-depends-on="mastica_solo_lado" data-validation-error-msg="Debe indicar la razon">
                                <option value="" selected>Selecione..</option>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="rechina_diente" name="rechina_diente">
                                <option value="" selected>Selecione..</option>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="cuando_articulacion" name="cuando_articulacion" data-validation="required" data-validation-depends-on="articulacion_temporomandibular" data-validation-error-msg="Debe especificar">
                                <option value="" selected>Selecione..</option>
                    ...
                    <div class="row row_border ">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="ciclo_dolor_cabeza" name="ciclo_dolor_cabeza" data-validation="required" data-validation-depends-on="dolor_cabeza" data-validation-error-msg="Debe indicar el ciclo de dolor">
                                <option value="" selected>Selecione..</option>
                    ...
                    <div class="row row_border">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            ...
                            <select style="color: black" id="condicion_sexual_id" name="condicion_sexual_id">
...
$(document).ready(function() {
    ...
    $('#Date').html(dayNames[newDate.getDay()] + " " + newDate.getDate() + ' ' + monthNames[newDate.getMonth()] + ' ' + newDate.getFullYear());
      $.each(antecendetes, function(i, val) {
        console.log("val",val)
        $('#abre_objeto_dientes').prop('checked', check('S', val.abre_objeto_dientes));
        $('#abrir_boca').prop('checked', check('S', val.abrir_boca));
        $('#afectando_salud').prop('checked', check('S', val.afectando_salud));
        $('#alimento_azucar').prop('checked', check('S', val.alimento_azucar));
        $('#apariencia_dientes').prop('checked', check('S', val.apariencia_dientes));
        $('#articulacion_temporomandibular').prop('checked', check('S', val.articulacion_temporomandibular));
        $('#ausencia_dientes').prop('checked', check('S', val.ausencia_dientes));
        $('#bebida_alcoholica').prop('checked', check('S', val.bebida_alcoholica));
        $('#id_enfermedad').val(val.id_historia_odontologica);
        $('#ciclo_dolor_cabeza').val(val.ciclo_dolor_cabeza);
        $('#condicion_sexual_id').val(val.condicion_sexual_id);
        $('#bostezar').prop('checked', check('S', val.bostezar));
        $('#cepillo_dental').prop('checked', check('S', val.cepillo_dental));
        $('#cerrar_boca').prop('checked', check('S', val.cerrar_boca));
        $('#cirugia_cavidad').prop('checked', check('S', val.cirugia_cavidad));
        $('#complic_pos_exo').prop('checked', check('S', val.complic_pos_exo));
        $('#control_dental_reg').prop('checked', check('S', val.control_dental_reg));
        $('#dificultad_boca').prop('checked', check('S', val.dificultad_boca));
        $('#dolor_atm_derecha').prop('checked', check('S', val.dolor_atm_derecha));
        $('#dolor_atm_izquierda').prop('checked', check('S', val.dolor_atm_izquierda));
        $('#dolor_cabeza').prop('checked', check('S', val.dolor_cabeza));
        $('#dolor_reciente_dentadura').prop('checked', check('S', val.dolor_reciente_dentadura));
        $('#droga').prop('checked', check('S', val.droga));
        $('#endodoncia').prop('checked', check('S', val.endodoncia));
        $('#exodoncia').prop('checked', check('S', val.exodoncia));
        $('#frecuencia_dolor_cabeza').prop('checked', check('S', val.frecuencia_dolor_cabeza));
        $('#frecuencia_hilo_dental').val(val.frecuencia_hilo_dental);
        $('#hilo_dental').prop('checked', check('S', val.hilo_dental));
        $('#lengua_contra_dientes').prop('checked', check('S', val.lengua_contra_dientes));
        $('#mastica_alimentos_blandos').prop('checked', check('S', val.mastica_alimentos_blandos));
        $('#mastica_alimentos_duros').prop('checked', check('S', val.mastica_alimentos_duros));
        $('#mastica_solo_lado').prop('checked', check('S', val.mastica_solo_lado));
        $('#masticar').prop('checked', check('S', val.masticar));
        $('#morder_fosforos').prop('checked', check('S', val.morder_fosforos));
        $('#morderse_labios').prop('checked', check('S', val.morderse_labios));
        $('#morderse_uyas').prop('checked', check('S', val.morderse_uyas));
        $('#nervios_tratamiento').prop('checked', check('S', val.nervios_tratamiento));
        $('#ortodoncia').prop('checked', check('S', val.ortodoncia));
        $('#otras_causas').prop('checked', check('S', val.otras_causas));
        $('#otros_medios').prop('checked', check('S', val.otros_medios));
        $('#periodoncia').prop('checked', check('S', val.periodoncia));
        $('#protesis_dental').prop('checked', check('S', val.protesis_dental));
        $('#reaccion_anestesico').prop('checked', check('S', val.reaccion_anestesico));
        $('#reir').prop('checked', check('S', val.reir));
        $('#respirar_boca').prop('checked', check('S', val.respirar_boca));
        $('#risa_sonrisa').prop('checked', check('S', val.risa_sonrisa));
        $('#sangra_encia').prop('checked', check('S', val.sangra_encia));
        $('#satisfecho_tratamiento').prop('checked', check('S', val.satisfecho_tratamiento));
        $('#sensibilidad_dental').prop('checked', check('S', val.sensibilidad_dental));
        $('#tabaco').prop('checked', check('S', val.tabaco));
        $('#tratamiento_odontologico').prop('checked', check('S', val.tratamiento_odontologico));
        $('#cuales_dientes_endodoncia').val(val.cuales_dientes_endodoncia);
        $('#cuales_medios').val(val.cuales_medios);
        $('#cuando_articulacion').val(val.cuando_articulacion);
        $('#cuando_endodoncia').val(val.cuando_endodoncia);
        $('#cuando_ortodoncia').val(val.cuando_ortodoncia);
        $('#dieta_habitual').val(val.dieta_habitual);
        $('#espec_cirugia').val(val.espec_cirugia);
        $('#espec_control_dental').val(val.espec_control_dental);
        $('#espec_exodoncia').val(val.espec_exodoncia);
        $('#espec_tratamiento_odon').val(val.espec_tratamiento_odon);
        $('#frecu_aliment_azucar').val(val.frecu_aliment_azucar);
        $('#razon_mastica').val(val.razon_mastica);
        $('#tipo_cepillo').val(val.tipo_cepillo);
        $('#tipo_complicacion').val(val.tipo_complicacion);
        $('#tipo_protesis').val(val.tipo_protesis);
        $('#tipo_tratamiento').val(val.tipo_tratamiento);
        $('#ultima_visita_odo').val(val.ultima_visita_odo);
        $('#frecuencia_cepillado').val(val.frecuencia_cepillado);
...
function validar() {
    ...
    $.ajax({
        ...
        url: "{{ url('/validar_historia_odontologica') }}",
        type: "POST",
        data: {
        ...
        success: function(data) {
            ...
            new PNotify({
                ...
                text: 'La Hsitoria Odontologica ha sido validada!',
                type: 'success',
                styling: 'bootstrap3'
            });
             new PNotify({
...
function insertar_odontologica() {
    ...
    $.validate({
        ...
        onSuccess: function($form) {
            ...
            $.ajax({
                url: "{{ url('/update_historiaOdontologica') }}",
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
