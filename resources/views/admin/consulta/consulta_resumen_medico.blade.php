                ...
                <fieldset>
                    ...
                    <input type="hidden" name="id_enfermedad" id="id_enfermedad">
                        ...
                        <div class="form-group">
                            ...
                            @endif
                                <button type="submit" id="registrar-button" onclick="insertar_historia();" class="btn btn-primary">Registrar
                                </button>
...
$(document).ready(function() {
   ...
   console.log(val)
        $('#id_enfermedad').val(val.id_resumen_historia_medica);
        $('#rhm_1').val(val.rhm_1);
        $('#fecha').val(val.fecha);
    });
...
function validar() {
    ...
    $.ajax({
        ...
        url: "{{ url('/validar_resumen_medico') }}",
        type: "POST",
        data: {
