                ...
                <fieldset>
                    ...
                    <input type="hidden" name="id_enfermedad" id="id_enfermedad">
                        ...
                        <div class="row row_border ">
                            <div class="col-lg-12">
                                <textarea name="rho_1" id="rho_1" placeholder="Introduzca el Resumen" data-validation="required" data-validation-error-msg="Debe especificar el resumen" class="form-control" style="height: 100px;"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
...
$(document).ready(function() {
   ...
   console.log(val)
        $('#id_enfermedad').val(val.id_resumen_historia_odontologica);
        $('#rho_1').val(val.rho_1);
        $('#fecha').val(val.fecha);
    });
...
function insertar_historia() {
    ...
    $.validate({
        ...
        onSuccess: function($form) {
            ...
            $.ajax({
                url: "{{ url('/update_resumenOdontologico') }}",
                type: 'POST',
                data: formData,
                async: false,
                cache: false,
