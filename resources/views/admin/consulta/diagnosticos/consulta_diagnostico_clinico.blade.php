		...
		<div class="col-lg-10 col-sm-8 col-sm-offset-4 col-lg-offset-2 col-md-offset-4">
          ...
          <input type="hidden" name="id_enfermedad" id="id_enfermedad">
           ...
           <div class="row row_border ">
            ...
            <div class="col-lg-12">
               <select name="especialidad" id="especialidad" class="form-control" onchange="buscar()">
    ...
    onSuccess : function($form) {
      ...
      var formData = new FormData($("#form_familiares")[0]);
        $.ajaxSetup({
          ...
          $.ajax({
            url: "{{ url('/update_diagnostico_clinico') }}",
            type: 'POST',
            data: formData,
            async: false,
            cache: false,
