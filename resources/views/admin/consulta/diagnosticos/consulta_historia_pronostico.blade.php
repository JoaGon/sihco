                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    <td>
                                        <strong>
                                <a href="{{ url('consulta_pronostico/'.$ante->id_pronostico.'/'.$ante->paciente_id) }}" class="btn btn-link" style="font-weight: bold" data-toggle="tooltip" title="nro_historia"> {{$ante->id_pronostico}} </a>
                                </strong>
                                    </td>
                                    <td class="name">
                                        {{$ante->consulta_id}}
