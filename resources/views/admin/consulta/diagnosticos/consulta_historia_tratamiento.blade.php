                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    <td>
                                        <strong>
                                <a href="{{ url('consulta_tratamiento/'.$ante->id_tratamientos.'/'.$ante->paciente_id) }}" class="btn btn-link" style="font-weight: bold" data-toggle="tooltip" title="nro_historia"> {{$ante->id_tratamientos}} </a>
                                </strong>
                                    </td>
                                    <td class="name">
                                        {{$ante->consulta_id}}
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        @if($ante->especialidad == 1)
                                            Periodocia
                                        @elseif($ante->especialidad == 2)
                                            Estomatologia
                                        @elseif($ante->especialidad == 3)
                                            Endodoncia
                                        @endif
                                    </td>
                                    <td>
