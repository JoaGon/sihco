			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" background-color:white;padding-left:0; margin-top: 25px">
				...
				<form class="form-horizontal" id="form_familiares">
					...
					<div class="col-lg-12">
						...
						<div class="col-lg-12">
							<textarea name="pigmentacion" id="pigmentacion" placeholder="Especifique" data-validation="required" data-validation-error-msg="Debe especificar" class="form-control" style="height: 100px;"></textarea>
						</div>
					</div>
					<div class="row row_border ">
					<div class="col-lg-12">
					 	<label>
							...
							<select style="color: black" id="viscosidad" name="viscosidad"  data-validation="required" data-validation-error-msg="Debe indicar que tipo">
...
$('#Date').html(dayNames[newDate.getDay()] + " " + newDate.getDate() + ' ' + monthNames[newDate.getMonth()] + ' ' + newDate.getFullYear());
 $.each(antecendetes, function(i, val) {
        ...
        $('#cabeza').val(val.cabeza);
        $('#cara').val(val.cara);
        $('#carrillos').val(val.carrillos);
        $('#cuello').val(val.cuello);
        $('#labios').val(val.labios);
        $('#lengua').val(val.lengua);
        $('#mucosa_labial_bucal').val(val.mucosa_labial_bucal);
        $('#observaciones').val(val.observaciones);
        $('#orofaringe').val(val.orofaringe);
        $('#paladar_duro_blando').val(val.paladar_duro_blando);
        $('#piel').val(val.piel);
        $('#pigmentacion').val(val.pigmentacion);
        $('#piso_boca').val(val.piso_boca);
        $('#viscosidad').val(val.viscosidad);
        $('#id_enfermedad').val(val.id_examen_clinico);
        $('#fecha').val(val.fecha);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            new PNotify({
                ...
                text: 'El examen Clinico ha sido validado!',
                type: 'success',
                styling: 'bootstrap3'
            });
             new PNotify({
