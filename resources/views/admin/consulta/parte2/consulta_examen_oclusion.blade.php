                 ...
                 {{ csrf_field() }}
                    ...
                    <div class="form-group">
                       ...
                       <select id="dtool">
                        ...
                        <a type="button" onclick="clear()" class="btn btn-primary">Clear</a>
...
<script type="text/javascript" src="{{ url('plugins/main/src/wPaint.menu.main2.js')}}"></script>
<!-- wPaint text -->
   ...
   $("#fecha").datepicker({
    ...
    $('#Date').html(dayNames[newDate.getDay()] + " " + newDate.getDate() + ' ' + monthNames[newDate.getMonth()] + ' ' + newDate.getFullYear());
     ...
     $.each(antecendetes, function(i, val) {
        console.log("val",val)
        $('#a_tope_anterior').prop('checked', check('S', val.a_tope_anterior));
        $('#a_tope_posterior_derecha').prop('checked', check('S', val.a_tope_posterior_derecha));
        $('#a_tope_posterior_izquierda').prop('checked', check('S', val.a_tope_posterior_izquierda));
        $('#abierta_anterior').prop('checked', check('S', val.abierta_anterior));
        $('#abierta_posterior_derecha').prop('checked', check('S', val.abierta_posterior_derecha));
        $('#abierta_posterior_izquierda').prop('checked', check('S', val.abierta_posterior_izquierda));
        $('#clase_dos').prop('checked', check('S', val.clase_dos));
        $('#clase_tres').prop('checked', check('S', val.clase_tres));
        $('#cruzada_anterior').prop('checked', check('S', val.cruzada_anterior));
        $('#fistula').prop('checked', check('S', val.fistula));
        $('#cruzada_posterior_derecha').prop('checked', check('S', val.cruzada_posterior_derecha));
        $('#cruzada_posterior_izquierda').prop('checked', check('S', val.cruzada_posterior_izquierda));
        $('#deslizamiento_anterior').prop('checked', check('S', val.deslizamiento_anterior));
        $('#deslizamiento_derecha').prop('checked', check('S', val.deslizamiento_derecha));
        $('#deslizamiento_izquierda').prop('checked', check('S', val.deslizamiento_izquierda));
        $('#desviacion_derecha').prop('checked', check('S', val.desviacion_derecha));
        $('#desviacion_izquierda').prop('checked', check('S', val.desviacion_izquierda));
        $('#desviacion_ninguna').prop('checked', check('S', val.desviacion_ninguna));
        $('#dimension_aumentada').prop('checked', check('S', val.dimension_aumentada));
        $('#dimension_disminuida').prop('checked', check('S', val.dimension_disminuida));
        $('#dimension_normal').prop('checked', check('S', val.dimension_normal));
        $('#funcion_grupo').prop('checked', check('S', val.funcion_grupo));
        $('#guia_canina').prop('checked', check('S', val.guia_canina));
        $('#guia_incisiva').prop('checked', check('S', val.guia_incisiva));
        $('#normoclusion').prop('checked', check('S', val.normoclusion));
     

        $('#dvo').val(val.dvo);
        $('#dvr').val(val.dvr);
        $('#fremilus').val(val.fremilus);
        $('#max_apertura').val(val.max_apertura);
        $('#max_lat_derecha').val(val.max_lat_derecha);
        $('#max_lat_izquierda').val(val.max_lat_izquierda);
        $('#max_protrusion').val(val.max_protrusion);
        $('#maxima_apertura').val(val.maxima_apertura);
        $('#maxima_lat_derecha').val(val.maxima_lat_derecha);
        $('#maxima_lat_izquierda').val(val.maxima_lat_izquierda);
        $('#maxima_protrusion').val(val.maxima_protrusion);
        $('#sobremordida_horizontal').val(val.sobremordida_horizontal);
        $('#sobremordida_vertical').val(val.sobremordida_vertical);
        $('#total').val(val.total);
     
    
        $('#id_enfermedad').val(val.id_oclusion);
        $('#fecha').val(val.fecha);
        ...
        var context = c.getContext('2d');
          ...
          img.onload = function() {
            context.drawImage(this, 0, 0, 900, 300);
          }

          img.src = val.contacto_en_maxima
        ...
        var context2 = c2.getContext('2d');
          ...
          img2.onload = function() {
            context2.drawImage(this, 0, 0, 900, 300);
          }

          img2.src = val.interferencia_derecha
        ...
        var context3 = c3.getContext('2d');
          ...
          img3.onload = function() {
            context3.drawImage(this, 0, 0, 900, 300);
          }

          img3.src = val.interferencia_izquierda
        ...
        var context4 = c4.getContext('2d');
          ...
          img4.onload = function() {
            context4.drawImage(this, 0, 0, 900, 300);
          }

          img4.src = val.interferencia_protrusivo
        ...
        var context5 = c5.getContext('2d');
          ...
          img5.src = val.contacto_prematuro
...
function clear(){
  ...
  var  c2=document.getElementById("imageView2");
    var context2 = c2.getContext('2d');
    context2.clearRect(0, 0, 900, 300);


  var  c3=document.getElementById("imageView3");
    var context3 = c3.getContext('2d');
    context3.clearRect(0, 0, 900, 300);


  var  c4=document.getElementById("imageView4");
    var context4 = c4.getContext('2d');
    context4.clearRect(0, 0, 900, 300);


  var  c5=document.getElementById("test");
    var context5 = c5.getContext('2d');
    context5.clearRect(0, 0, 900, 300);
   ...
   var c=document.getElementById("imageView");
    ...
    $.validate({
        ...
        onSuccess: function($form) {
            ...
            formData.append('interferencia_derecha', d2);
            formData.append('interferencia_izquierda', d3);
            formData.append('contacto_en_maxima', d);
            formData.append('interferencia_protrusivo', d4);
            formData.append('contacto_prematuro', d5);
