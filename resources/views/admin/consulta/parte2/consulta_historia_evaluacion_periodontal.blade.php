                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    <td>
                                        <strong>
                                <a href="{{ url('consulta_evaluacionPeriodontal/'.$ante->id_evaluacion_periodontal.'/'.$ante->paciente_id) }}" class="btn btn-link" style="font-weight: bold" data-toggle="tooltip" title="Cita"> {{$ante->id_evaluacion_periodontal}} </a>
                                </strong>
                                    </td>
                                    <td class="name">
                                        {{$ante->consulta_id}}
