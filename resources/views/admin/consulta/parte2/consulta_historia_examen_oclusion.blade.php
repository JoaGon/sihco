                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody class="list">
                                ...
                                <tr>
                                    <td>
                                        <strong>
                                <a href="{{ url('consulta_oclusion/'.$ante->id_oclusion.'/'.$ante->paciente_id) }}" class="btn btn-link" style="font-weight: bold" data-toggle="tooltip" title="Cita"> {{$ante->id_oclusion}} </a>
                                </strong>
                                    </td>
                                    <td class="name">
                                        {{$ante->consulta_id}}
