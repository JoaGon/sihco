...
$.each(antecendetes, function(i, val) {
        console.log("val",val)
        $('#bacteriana').prop('checked', check('S', val.bacteriana));
        $('#bolsa_periodontal').prop('checked', check('S', val.bolsa_periodontal));
        $('#calculos').prop('checked', check('S', val.calculos));
        $('#calor').prop('checked', check('S', val.calor));
        $('#calor_sensibilidad').prop('checked', check('S', val.calor_sensibilidad));
        $('#cambio_color').prop('checked', check('S', val.cambio_color));
        $('#caries').prop('checked', check('S', val.caries));
        $('#coronas_metal').prop('checked', check('S', val.coronas_metal));

        $('#dolor_constante').prop('checked', check('S', val.dolor_constante));
        $('#dolor_difuso').prop('checked', check('S', val.dolor_difuso));
        $('#dolor_espontaneo').prop('checked', check('S', val.dolor_espontaneo));
        $('#dolor_intermitente').prop('checked', check('S', val.dolor_intermitente));
        $('#dolor_localizado').prop('checked', check('S', val.dolor_localizado));
        $('#dolor_palpitante').prop('checked', check('S', val.dolor_palpitante));
        $('#dolor_provocado').prop('checked', check('S', val.dolor_provocado));
        $('#dolor_referido').prop('checked', check('S', val.dolor_referido));


        $('#espacio_periodontal').prop('checked', check('S', val.espacio_periodontal));
        $('#faceta_articular').prop('checked', check('S', val.faceta_articular));
        $('#fines_protesicos').prop('checked', check('S', val.fines_protesicos));
        $('#fines_terapeuticos').prop('checked', check('S', val.fines_terapeuticos));
        $('#fisica').prop('checked', check('S', val.fisica));
        $('#fistula').prop('checked', check('S', val.fistula));
        $('#fisura').prop('checked', check('S', val.fisura));
        $('#fractura_corona').prop('checked', check('S', val.fractura_corona));


        $('#diente_tratar').val(val.diente_tratar);
        $('#id_enfermedad').val(val.id_endodoncia);


        $('#fractura_radicular').prop('checked', check('S', val.fractura_radicular));
        $('#frenillos').prop('checked', check('S', val.frenillos));
        $('#frio').prop('checked', check('S', val.frio));
        $('#frio_sensibilidad').prop('checked', check('S', val.frio_sensibilidad));
        $('#gingivitis').prop('checked', check('S', val.gingivitis));
        $('#glandulas_salivales').prop('checked', check('S', val.glandulas_salivales));
        $('#infla_extraoral').prop('checked', check('S', val.infla_extraoral));
        $('#infla_intraoral').prop('checked', check('S', val.infla_intraoral));
        $('#labios').prop('checked', check('S', val.labios));
        $('#lengua').prop('checked', check('S', val.lengua));
        $('#movilidad').prop('checked', check('S', val.movilidad));
        $('#mucosa_oral').prop('checked', check('S', val.mucosa_oral));

        $('#musculos_masticatorios').prop('checked', check('S', val.musculos_masticatorios));
        $('#nucleo').prop('checked', check('S', val.nucleo));
        $('#obsturaciones').prop('checked', check('S', val.obsturaciones));

        $('#otros').prop('checked', check('S', val.otros));
        $('#paladar_blando').prop('checked', check('S', val.paladar_blando));
        $('#paladar_duro').prop('checked', check('S', val.paladar_duro));
        $('#palpacion').prop('checked', check('S', val.palpacion));
        $('#percusion_vertical').prop('checked', check('S', val.percusion_vertical));

        $('#perdida_alveolar').prop('checked', check('S', val.perdida_alveolar));
        $('#periodontitis').prop('checked', check('S', val.periodontitis));
        $('#piso_boca').prop('checked', check('S', val.piso_boca));


        $('#placa').prop('checked', check('S', val.placa));
        $('#prueba_electrica').prop('checked', check('S', val.prueba_electrica));
        $('#quimica').prop('checked', check('S', val.quimica));
        $('#radiopacidad_apical').prop('checked', check('S', val.radiopacidad_apical));
        $('#raiz_formacion').prop('checked', check('S', val.raiz_formacion));

        $('#reabsorcion_externa').prop('checked', check('S', val.reabsorcion_externa));
        $('#reabsorcion_interna').prop('checked', check('S', val.reabsorcion_interna));
        $('#sist_linfatico').prop('checked', check('S', val.sist_linfatico));



        $('#test_cavidad').prop('checked', check('S', val.test_cavidad));
        $('#tratamiento_endodontico').prop('checked', check('S', val.tratamiento_endodontico));
        $('#trauma').prop('checked', check('S', val.trauma));
        $('#zona_radiolucida').prop('checked', check('S', val.zona_radiolucida));
        $('#zona_radiolucida_furca').prop('checked', check('S', val.zona_radiolucida_furca));

        $('#zona_radiolucida_lateral').prop('checked', check('S', val.zona_radiolucida_lateral));
       
        
        $('#observacion').val(val.observacion);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            new PNotify({
                ...
                text: 'La endodoncia ha sido validado!',
                type: 'success',
                styling: 'bootstrap3'
            });
             new PNotify({
