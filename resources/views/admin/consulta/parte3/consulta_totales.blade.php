...
$.each(antecendetes, function(i, val) {
        ...
        $('#tipo_detadura_nunguna').prop('checked', check('S', val.tipo_detadura_nunguna));
        $('#tipo_detadura_inf').prop('checked', check('S', val.tipo_detadura_inf));
        $('#tipo_detadura_ambas').prop('checked', check('S', val.tipo_detadura_ambas));
        $('#maxilar_caries').prop('checked', check('S', val.maxilar_caries));
        $('#maxilar_anos').prop('checked', check('S', val.maxilar_anos));
        $('#maxilar_ambas').prop('checked', check('S', val.maxilar_ambas));
        $('#maxilar_accidente').prop('checked', check('S', val.maxilar_accidente));
        $('#mandibular_caries').prop('checked', check('S', val.mandibular_caries));
        $('#mandibular_anos').prop('checked', check('S', val.mandibular_anos));
        $('#mandibular_ambas').prop('checked', check('S', val.mandibular_ambas));
        $('#mandibular_accidente').prop('checked', check('S', val.mandibular_accidente));
        $('#eval_menos').prop('checked', check('S', val.eval_menos));
        $('#eval_mas').prop('checked', check('S', val.eval_mas));
        $('#dentadura_uso').prop('checked', check('S', val.dentadura_uso));
        $('#dentadura_si_usuado').prop('checked', check('S', val.dentadura_si_usuado));
        $('#dentadura_ninguna').prop('checked', check('S', val.dentadura_ninguna));
        $('#dentadura_mala').prop('checked', check('S', val.dentadura_mala));
        $('#dentadura_buena').prop('checked', check('S', val.dentadura_buena));
        $('#abertura_boca').val(val.abertura_boca);
        $('#anchura').val(val.anchura);
        $('#comodidad').val(val.comodidad);
        $('#contorno_boveda').val(val.contorno_boveda);
        $('#contorno_paladar').val(val.contorno_paladar);
        $('#dentadura_cuanta').val(val.dentadura_cuanta);
        $('#dentadura_mandibular').val(val.dentadura_mandibular);
        $('#dentadura_maxilar').val(val.dentadura_maxilar);
        $('#depresibilidad').val(val.depresibilidad);
        $('#diente_inf').val(val.diente_inf);
        $('#diente_sup').val(val.diente_sup);
        $('#eficiencia_masticatoria').val(val.eficiencia_masticatoria);
        $('#espacio').val(val.espacio);
        $('#espacio_disp').val(val.espacio_disp);
        $('#espacion_disp_oclusal').val(val.espacion_disp_oclusal);
        $('#eval_comodidad').val(val.eval_comodidad);
        $('#eval_dimension_vertical').val(val.eval_dimension_vertical);
        $('#eval_dist_adecuada').val(val.eval_dist_adecuada);
        $('#eval_dolor').val(val.eval_dolor);
        $('#eval_efic_masticatoria').val(val.eval_efic_masticatoria);
        $('#eval_estabilidad').val(val.eval_estabilidad);
        $('#eval_estetica').val(val.eval_estetica);
        $('#eval_estetica_dent').val(val.eval_estetica_dent);

        $('#eval_extension').val(val.eval_extension);
        $('#eval_higiene').val(val.eval_higiene);



        $('#eval_oclusion').val(val.eval_oclusion);
        $('#eval_prese_cam').val(val.eval_prese_cam);
        $('#eval_pronunciacion').val(val.eval_pronunciacion);
        $('#eval_retencion').val(val.eval_retencion);
        $('#expresion_facial').val(val.expresion_facial);
        $('#forma_diente').val(val.forma_diente);
        $('#formula_anterior').val(val.formula_anterior);
        $('#formula_marca').val(val.formula_marca);
        $('#formula_posterior').val(val.formula_posterior);
        $('#insercion_inf').val(val.insercion_inf);
        $('#insercion_sup').val(val.espacio);
        $('#labios').val(val.labios);



        $('#mandibular_ausente').val(val.mandibular_ausente);
        $('#mandibular_presente').val(val.mandibular_presente);
        $('#mandibular_tam').val(val.mandibular_tam);
        $('#material').val(val.material);
        $('#material_base').val(val.material_base);
        $('#material_diente').val(val.material_diente);
        $('#mm').val(val.mm);
        $('#mm_vertical').val(val.mm_vertical);
        $('#numero_cita').val(val.numero_cita);

        $('#palatino_ausente').val(val.palatino_ausente);
        $('#palatino_presente').val(val.palatino_presente);
        $('#palatino_tam').val(val.palatino_tam);
        $('#piso_boca').val(val.piso_boca);
        $('#post_estetica').val(val.post_estetica);
        $('#pronunciacion').val(val.pronunciacion);
        $('#razon_reemplazo').val(val.razon_reemplazo);
        $('#reabsorcion_inf').val(val.reabsorcion_inf);
        $('#reabsorcion_sup').val(val.reabsorcion_sup);

          $('#relacion_borde').val(val.relacion_borde);
        $('#relacion_inter').val(val.relacion_inter);
        $('#relacion_labio_alveolar').val(val.relacion_labio_alveolar);
        $('#relacion_reborde').val(val.relacion_reborde);
        $('#resilencia_inf').val(val.resilencia_inf);
        $('#resilencia_sup').val(val.resilencia_sup);
        $('#seleccion_arti_color').val(val.seleccion_arti_color);
        $('#seleccion_arti_marca').val(val.seleccion_arti_marca);
        $('#seleccion_inf').val(val.seleccion_inf);

          $('#seleccion_sup').val(val.seleccion_sup);
        $('#tam_inf').val(val.tam_inf);
        $('#tam_sup').val(val.tam_sup);
        $('#tiempo_uso').val(val.tiempo_uso);
        $('#uso_dentadura').val(val.uso_dentadura);

        $('#tipo_detadura_sup').val(val.tipo_detadura_sup);
   
        $('#fecha').val(val.fecha);

        $('#id_enfermedad').val(val.id_dentadura_total);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            new PNotify({
                ...
                text: 'Las dentaduras totales ha sido validado!',
                type: 'success',
                styling: 'bootstrap3'
            });
             new PNotify({
