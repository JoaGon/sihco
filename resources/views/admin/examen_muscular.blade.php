		...
		<div class="col-lg-10 col-sm-8 col-sm-offset-4 col-lg-offset-2 col-md-offset-1">
			...
			<div class=" col-lg-12 col-md-12 col-sm-12 col-xs-12" style=" background-color:white;padding-left:0; margin-top: 25px">
				...
				<form class="form-horizontal" id="form_familiares">
					...
					<div class="col-lg-12">
						<label>
							A. Palpación de los músculos extraorales: (use una 
							  presión de 1 kg. Marque el código en el sitio correspondiente utilizando la 
							  siguiente escala para medir el dolor: 0 = Ausencia de dolor / presión 
							  solamente; 1 = Dolor leve; 2 = Dolor moderado; 3 = Dolor severo)   
						...
						<div class="col-lg-12">
							<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-left-width:0; border-right-width:0" bordercolor="#FFFF00" id="AutoNumber1" width="650">
							    ...
							    <tr>
							      ...
							      <font><b>
							      Der.<input type="text" name="temporal_posterio_der" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" size="2" style=" width: 100%; color: black; text-align: center"></b></font></td>
							      ...
							      <font><b>
							      Izq.<input type="text" name="temporal_posterio_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="189" rowspan="5" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1; margin-left: ">
								      <p align="center">
								      <img border="0" src="{{ url('/images/temporal_DP.jpg')}}" style="margin: 15px" width="189" height="203">
								      Temporal/Digastrico posterior
								      </p>
							      </td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="temporar_medio_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="temporar_medio_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="temporal_anterior_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="temporal_anterior_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="origen_masetero_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="origen_masetero_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="cuerpo_masetero_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="cuerpo_masetero_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="insercion_masetero_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="insercion_masetero_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      ...
							      <p align="center">
							      <img border="0" src="{{ url('/images/masetero_da.jpg')}}" width="189" style="margin: 15px" height="198">
							      Masetero/Digastrico anterior
							      </p>
							      </td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="region_mandibular_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="region_mandibular_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="region_submandibular_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="region_submandibular_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="esternocleidomastoideo_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="esternocleidomastoideo_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      ...
							      <td width="30" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="musculatura_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="22" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="musculatura_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							  </tbody>
						  </table>
						</div>
				...
				<div class="col-lg-12">
					<label>
						B. Palpación de los músculos intraorales: (use una presión de 0.5 kg. Marque el código en el sitio 
							  correspondiente utilizando la siguiente escala para medir el dolor: 0 = 
							  Ausencia de dolor / presión solamente; 1 = Dolor leve; 2 = Dolor moderado; 3 = 
							  Dolor severo)    
					</label>
				</div>
					<div class="col-lg-12">
							<table border="1" cellpadding="0" cellspacing="0" style="border-width:0; border-collapse: collapse" bordercolor="#FFFF00" id="AutoNumber1" width="693">
							    <tbody><tr>
							      ...
							      1</font></b></td>
							      <td width="432" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font><b>
							      Área del pterigoideo lateral (por encima de los molares superiores)</b></font></td>
							      ...
							      <font><b>Der.
							      <input type="text" name="area_pterigoide_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      ...
							      <font><b>
							      Izq.<input type="text" name="area_pterigoide_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black;text-align: center"></b></font></td>
							      <td width="175" rowspan="5" style="border-style: none; border-width: medium">
							      <p>
							      <img border="0" src="{{ url('/images/plerigoideo.jpg')}}" width="190" style="margin: 15px" height="230">
							          	Pterigoideo lateral</p></td>
							    </tr>
							    <tr>
							      <td align="center" width="35" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><b><font>
							      2</font></b></td>
							      <td width="432" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font><b>
							      Tendón del temporal (tendón)</b></font></td>
							      <td width="28" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="tendon_temp_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="23" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="tendon_temp_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
					...
					<div class="col-lg-12">
							<table border="1" cellpadding="0" cellspacing="0" style="border-width:0; border-collapse: collapse" bordercolor="#FFFF00" id="AutoNumber1" width="693">
							    <tbody><tr>
							      ...
							      1</font></b></td>
							      <td width="432" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font><b>
							      Polo lateral (por la parte externa)</b></font></td>
							      <td width="28" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      Der.<input type="text" name="polo_lateral_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="23" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      Izq.<input type="text" name="polo_lateral_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="175" rowspan="5" style="border-style: none; border-width: medium"><p>
							      <img border="0" src="{{ url('/images/tendon_temp.jpg')}}" style="margin: 15px" width="198" height="236">
							      Tendon Temporal</p></td>
							    </tr>
							    <tr>
							      <td align="center" width="35" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><b><font>
							      2</font></b></td>
							      <td width="432" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1"><font><b>
							      Inserción posterior (dentro del oído)</b></font></td>
							      <td width="28" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="insercion_pos_der" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							      <td width="23" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-top-style: solid; border-top-width: 1; border-bottom-style: solid; border-bottom-width: 1" align="center">
							      <font><b>
							      <input type="text" name="insercion_pos_izq" size="2" data-validation="number" data-validation-allowing="range[0;3]" data-validation-error-msg="Invalido" style="width: 100%; color: black; text-align: center"></b></font></td>
							    </tr>
							    <tr>
							      <td align="center" width="35" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium">&nbsp;</td>
							      <td width="432" style="border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; border-bottom-style: none; border-bottom-width: medium">&nbsp;</td>
					...
					<div class="col-lg-12">
							<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-left-width:0; border-right-width:0; border-bottom-width:0" bordercolor="#FFFF00" id="AutoNumber3">
							    <tbody><tr>
							      ...
							      &nbsp;</td>
							      <td align="center" rowspan="6" style="border-bottom:1px solid #FFFF00; border-top:1px solid #FFFF00; border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; "><p>
							      <img border="0" src="{{ url('/images/atm.jpg')}}" width="185" style="margin: 15px" height="218">
							      ATM</p></td>
							    </tr>
							    <tr>
					...
					<div class="col-lg-12">
						<table border="1" cellpadding="0" cellspacing="0" style="border-collapse: collapse; border-left-width:0; border-right-width:0; border-bottom-width:0" bordercolor="#FFFF00" id="AutoNumber4">
						    <tbody><tr>
						      ...
						      &nbsp;</td>
						      <td align="center" rowspan="6" style="border-bottom:1px solid #FFFF00; border-top:1px solid #FFFF00; border-left-style: none; border-left-width: medium; border-right-style: none; border-right-width: medium; "><p>
						      <img border="0" src="{{ url('/images/atm_izq.jpg')}}" width="185" style="margin: 15px" height="215">
						      ATM</p></td>
						    </tr>
						    <tr>
