      ...
      <table border="0" cellspacing="0" cellpadding="0">
        <test>
          <tr style="border:1px solid black">
           <th class="qty" style="text-align:center;border:1px solid black;background:#eee">Nro Historia</th>
            ...
            <th class="patro" style="text-align:center;border:1px solid black;background:#eee">Tel&eacute;fono</th>
            <th class="total" style="text-align:center;border:1px solid black;background:#eee">Direccion</th>
            <th class="total" style="text-align:center;border:1px solid black;background:#eee">Fecha Ingreso</th>
