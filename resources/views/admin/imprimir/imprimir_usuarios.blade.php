...
<header class="clearfix">
    <div class="container ">
      ...
      <div class="company-info" style="float:right">
        <h2 class="title" style="color:black">Reporte Usuarios </h2>
        ...
        <test>
          <tr style="border:1px solid black">
            ...
            <th class="total" style="text-align:center;border:1px solid black;background:#eee">Direccion</th>
             <th class="qty" style="text-align:center;border:1px solid black;background:#eee">Rol</th>
        ...
        <tbody>
          @foreach($data as $item)
            <tr>
              ...
              <td class="total">{{ $item->rol_name }}</td>
