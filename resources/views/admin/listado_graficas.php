...
<br/>
	...
	<div class="box box-primary">
		...
		<div class="box-body" id="div_grafica_barras1" >
		</div>
	...
	<div class="box box-primary">
		...
		<div class="box-body" id="div_grafica_barras2">
		</div>
...
cargar_grafica_pie();
cargar_grafica_pie1();
cargar_grafica_barras1(<?= $anio; ?>,<?= intval($mes); ?>);
cargar_grafica_barras2(<?= $anio; ?>,<?= intval($mes); ?>);
</script>
