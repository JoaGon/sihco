                ...
                <div class="col-lg-10 col-sm-8 col-sm-offset-2 col-lg-offset-2 col-md-offset-4" style=" background-color:white;padding-left:0; margin-top: 25px">
                    ...
                    foreach ($imagen as $im) {
                        $ruta_temp = url('/') . '/' . $im->ruta; ?>
                                    <div style="clear:both;" onclick="big_imaging('{!!$im->ruta!!}', '{!!$im->id_registro_imageneologico!!}');"> <img src="{!!url('/').'/'.$im->ruta!!}" class="btn" style="float: left; width: 70px; higth: 70px;">
                                        <label style="margin-left: 20%;">
                                            <?php
                                if ($im->titulo_imagen) { echo $im->titulo_imagen; } else { echo 'Sin titulo'; } ?>
                                        </label>
                                    </div>
                                    <br>
                                    <?php } ?>
