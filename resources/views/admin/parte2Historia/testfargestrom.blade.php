                                            ...
                                            <table class="table table-striped table-bordered table-hover" style=" color: #000;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" value="3" id="tiempo" name="primer_cigarrillo" checked> Hata 5 minutos
                                                        </td>
                                                        <td>
                                                            3
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" value="2" id="tiempo" name="primer_cigarrillo"> entre 6 - 30 minutos
                                                        </td>
                                                        <td>
                                                            2
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" value="1" id="tiempo" name="primer_cigarrillo"> 31 - 60 minutos
                                                        </td>
                                                        <td>
                                                            1
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" value="0" id="tiempo" name="primer_cigarrillo"> Mas de 60 minutos
                                                        </td>
                                                        <td>
                                                            0
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" id="dificil" value="1" name="fumar_en_lugares" checked> Si
                                                        </td>
                                                        <td>
                                                            1
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" id="dificil" value="0" name="fumar_en_lugares"> No
                                                        </td>
                                                        <td>
                                                            0
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" id="molesta" value="1" name="molesta_mas" checked> El primero de la manana?
                                                        </td>
                                                        <td>
                                                            1
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" id="molesta" value="0" name="molesta_mas"> Cualquier Otro
                                                        </td>
                                                        <td>
                                                            0
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="radio" id="dia" value="0" name="cigarro_por_dia" checked> 10 o menos
                                                        </td>
                                                        <td>
                                                            0
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" id="dia" value="1" name="cigarro_por_dia"> 11 - 20
                                                        </td>
                                                        <td>
                                                            1
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" id="2" value="2" name="cigarro_por_dia"> 21 - 30
                                                        </td>
                                                        <td>
                                                            2
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="radio" id="dia" value="3id" name="cigarro_por_dia"> 31 o mas
                                                        </td>
                                                        <td>
                                                            3
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="radio" id="frecuencia" value="1" name="fuma_frecuencia" checked> Si
                                                            </td>
                                                            <td>
                                                                1
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="radio" id="frecuencia" value="0" name="fuma_frecuencia"> No
                                                            </td>
                                                            <td>
                                                                0
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="radio" value="1" id="enfermo" name="fuma_enfermo" checked> Si
                                                            </td>
                                                            <td>
                                                                1
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <input type="radio" value="0" id="enfermo" name="fuma_enfermo"> No
                                                            </td>
                                                            <td>
                                                                0
                                                            </td>
