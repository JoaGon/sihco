                                ...
                                <table class="table table-striped table-bordered table-hover" style=" color: #000;">
                                    ...
                                    <tbody>
                                       <tr>
									      ...
									      <td>
									      <input type="radio" value="3" id="tiempo" name="primer_cigarrillo" checked>
									      Hata 5 minutos
									      </td>
									       <td>
									      3
								      ...
								      <tr>
									      <td>
									      <input type="radio" value="2" id="tiempo" name="primer_cigarrillo">
									      entre 6 - 30 minutos
									      </td>
									       <td>
									     2
								       ...
								       <tr>
									      <td>
									      <input type="radio" value="1" id="tiempo" name="primer_cigarrillo">
									     31 - 60 minutos
									      </td>
									       <td>
									      1
								       ...
								       <tr>
									      <td>
									      <input type="radio" value="0" id="tiempo" name="primer_cigarrillo">
								      ...
								      <tr>
									     ...
									     Encuentra dificil no fumar en lugares donde esta prohibido, como la biblioteca o el cine?
									      ...
									      <td>
									      <input type="radio" id="dificil" value="1" name="fumar_en_lugares" checked>
								      ...
								      <tr>
									      <td>
									      <input type="radio" id="dificil" value="0" name="fumar_en_lugares">
									      No
									      </td>
									       <td>
									     0
								      ...
								      <tr>
									     ...
									     Que cigarrillo le molesta mas dejar de fumar?
									      ...
									      <td>
									      <input type="radio" id="molesta" value="1" name="molesta_mas" checked>
								      ...
								      <tr>
									      <td>
									      <input type="radio" id="molesta" value="0" name="molesta_mas">
								      ...
								      <tr>
									     ...
									     Cuantos cigarros fuma cada dia?
									      ...
									      <td>
									      <input type="radio" id="dia" value="0" name="cigarro_por_dia" checked>
								      ...
								      <tr>
									      <td>
									      <input type="radio" id="dia" value="1" name="cigarro_por_dia">
								       ...
								       <tr>
									      <td>
									      <input type="radio" id="2" value="2" name="cigarro_por_dia">
								       ...
								       <tr>
									      <td>
									      <input type="radio" id="dia" value="3id" name="cigarro_por_dia">
								      ...
								      <tr>
									     ...
									     Fuma con mas frecuencia durante las primeras horas despues de levantarse que durante el resto del dia?
									      ...
									      <td>
									      <input type="radio" id="frecuencia" value="1" name="fuma_frecuencia" checked>
								      ...
								      <tr>
									      <td>
									      <input type="radio" id="frecuencia" value="0" name="fuma_frecuencia">
								      ...
								      <tr>
									     ...
									     Fuma aunque este tan enfermo que tenga que guardar cama la mayor parte del dia?
									      ...
									      <td>
									      <input type="radio" value="1" id="enfermo" name="fuma_enfermo" checked>
								      ...
								      <tr>
									      <td>
									      <input type="radio" value="0" id="enfermo" name="fuma_enfermo">
